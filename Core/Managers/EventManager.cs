...
using Depra.EventSystem.Core.Handlers.Static;

namespace Depra.EventSystem.Core
{
    public static class EventManager
    {
        ...
        //public static DisposeContainer Add<T>(string key, Func<T> action) => DelegateEventHandler.Add(key, action);
